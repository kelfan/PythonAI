# diagram of history data
```python
import pandas
import matplotlib.pyplot as plt
dataset = pandas.read_csv('shanghaiCompositeIndex2.csv', usecols=[1], engine='python', skipfooter=3)
plt.plot(dataset)
plt.show()
```
![](assets/README-bd30f303.png)
